...
class AIONTrainer(BaseTrainer):
    ...
    def _create_optimizer(self) -> torch.optim.Optimizer:
        ...
        params = list(self.euclid_to_hsc.parameters()) + list(self.hsc_to_euclid.parameters())
    ...
    def _codec_roundtrip_flux(self, hsc_flux: torch.Tensor) -> torch.Tensor:
        ...
        try:
            ...
            raise ImportError("AION not found. Initialize submodules: git submodule update --init")
